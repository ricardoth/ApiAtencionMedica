...
{
    /// <inheritdoc />
    public partial class InitDbpoblarTablasBase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Complicacion",
                columns: new[] { "IdComplicacion", "EsActivo", "NombreComplicacion" },
                values: new object[,]
                {
                    { 1, true, "Retinopatía" },
                    { 2, true, "Ceguera" },
                    { 3, true, "Insuficiencia Renal" },
                    { 4, true, "Pie Diabético" },
                    { 5, true, "Amputación" },
                    { 6, true, "Hipertrofia Ventricular Izquerda" },
                    { 7, true, "Enfermedad Cerebrovascular" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Especialidad",
                columns: new[] { "IdEspecialidad", "EsActivo", "NombreEspecialidad" },
                values: new object[,]
                {
                    { 1, true, "Oftalmología" },
                    { 2, true, "Nutrición" },
            ...
            migrationBuilder.InsertData(
                table: "Patologia",
                columns: new[] { "IdPatologia", "EsActivo", "NombrePatologia" },
                values: new object[,]
                {
                    { 1, true, "Diabetes Mellitus" },
                    { 2, true, "Hipertensión Arterial" },
                    { 3, true, "Epilepsia" },
                    { 4, true, "Artrosis Rodillas" },
                    { 5, true, "Artrosis Caderas" },
                    { 6, true, "Intolerancia a la Glucosa" },
                    { 7, true, "Parkinson" }
                });
